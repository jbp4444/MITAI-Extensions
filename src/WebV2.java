...
public class WebV2 extends AndroidNonvisibleComponent implements Component {
  /**
   ...
   */
  public WebV2(ComponentContainer container) {
   ...
   */
  @SimpleProperty(category = PropertyCategory.BEHAVIOR,
      description = "The response headers, as a list of two-element sublists. The first element " +
